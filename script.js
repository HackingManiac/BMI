function calculateBMI() {
    ...
    if (height === "" || weight === ""||age==="") {
        ...
        if (bmi < 18.5) {
            ...
            result.innerHTML = `<h2 class="text-center">${bmi} kg/m²</h2><h4 class="text-center text-success">Normal</h4><p class="my-3">Maintain a balanced diet and regular physical activity to sustain overall health.</p>`;
        } else if (bmi < 30) {
